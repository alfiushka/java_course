 ...
 * 2022-11-23T11:22:21.544+03:00
 * Generated source version: 3.5.4
 *
 */
@WebServiceClient(name = "GeoIPService",
                  wsdlLocation = "file:/Users/alfiiashemendiuk/Desktop/java_course/soap-sample/src/main/resources/ipservice.wsdl.xml",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/alfiiashemendiuk/Desktop/java_course/soap-sample/src/main/resources/ipservice.wsdl.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/Users/alfiiashemendiuk/Desktop/java_course/soap-sample/src/main/resources/ipservice.wsdl.xml");
        }
        WSDL_LOCATION = url;
    }
